...
function ItemEditSupplier(props: any) {
    ...
    return (
        <div className="bg-gray-100 flex items-center border-b-2 border-solid border-gray-300  rounded-sm mx-2 p-2">
            ...
            <Link to="/createSupplier" state={{index: props.index}}><button onClick={handleEvent}><FaEdit className="w-[20px] h-[20px] ml-4"/></button></Link>
            <button onClick={deleteItem}><FaTrash className="w-[20px] h-[20px] ml-4"/></button>
