    ...
    return (
        <div className='w-[500px] m-7 flex justify-center'>
            <ul className='w-full'>
                ...
                {warning ? <li className='flex items-center p-2'><FaExclamationCircle className='text-red-500 mr-2' /><p className='text-red-500 font-semibold'> {status}</p></li> : <li><p></p></li>}
